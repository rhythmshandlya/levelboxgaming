...
export function Footeree() {
  const navigation = ["United States", "United Kingdom", "Canada", "China"];
  const legal = ["Safe and Fair Play", "Legal"];
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div className="mb-5">
              <Link href="/">
                <a className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  <span>
                    <img src="/img/logo-black.png" alt="LevelBoxGames" />
                  </span>
                </a>
              </Link>
            </div>

            <div className="max-w-md mt-5 text-gray-500 text-lg dark:text-gray-400 mb-6">
